        ...
        <div id="header">
            <div id="headerinside">
                <a href="index.jsp" target="_self" id="logo">
	                <img id="bigLogo" src="../upload/1493547468473.jpg" style="width:120px;" alt="" title="logo" />
	                <img id="miniLogo" src="../upload/1493547468473.jpg" style="width:40px;height:20px"alt="" title="logo" />
                ...
                <div id="searchbar" style="margin-top:15px">
                     <div id="saerkey">
                        <span id="key">
                        	<input type="text" id="keyword" name="proName" class="keyword2" placeholder="找你要的二手好物" />
                        </span>
                    </div>
                    <div class="inputcon">
